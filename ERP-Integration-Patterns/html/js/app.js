  ...
  function(oj, ko) { // this callback gets executed when all required modules are loaded
    ...
    function viewModel() {
      ...
      self.availableAppEnvironments = ko.observableArray([
        new AppEnvironment("ERP Cloud Purchasing - zjib", "https://adc3-zjib-fa-ext.oracledemos.com/fscmUI/faces/FuseWelcome?fndThemeName=Vision_Newsfeed", "casey.brown"),
        new AppEnvironment("ERP Cloud Payables - zjib",   "https://adc3-zjib-fa-ext.oracledemos.com/fscmUI/faces/FuseWelcome?fndThemeName=Vision_Newsfeed", "bala.gupta"),
      ]),
